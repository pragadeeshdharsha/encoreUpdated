...
func newDisbInfo(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	argStrings := []string{args[3], args[0], args[2], args[1], args[5]} //first 5 variables for updateLoanBalance
	argStr := strings.Join(argStrings, ",")
	chaincodeArgs = util.ToChaincodeArgs("updateLoanBalDisb", argStr)
